...
<div class="main-container">
    <div class="main-container__add w-400px">
        <div class="main-container__add-form">
            ...
            <form action="./form/ViewUser/KpiAct.php?page=luong&req=add_by_nv" method="post" enctype="multipart/form-data">
                <div class="form-group mt-1 d-flex">
                    <div class="form-group">
                        <label class="">Chọn kỳ</label>
                        <input type="hidden" name="id_index" value="<?=$id_index?>">
                        <input type="hidden" name="id_canbo" value="<?=$CanboGetbyId->id_canbo;?>">
                        <select name="id_index_" id="id_index" required="" onchange="location = this.value;"
                            class="form-control w-fct">
                            <option value="../user/indexuser.php?req=viewluong&id_index=<?= $indexcount__Get_By_Id->id_index;?>&id_canbo=<?= $indexcount__Get_By_Id->id_canbo?>">
                            ...
                            <option value="../user/indexuser.php?req=viewluong&id_index=<?= $item->id_index; ?>&id_canbo=<?= $indexcount__Get_By_Id->id_canbo?>">
                                <?= $item->ten_index; ?>
                    ...
                    <button class="btn btn-danger m-2 mt-4" type="button"
                        onclick="return confirm_sweet('./form/ViewUser/KpiAct.php?page=luong&req=delete&id_index=<?=$id_index?>')">Xóa đợt này
                    </button>
                    <?php else:?>
            ...
            <form action="./form/ViewUser/KpiAct.php?page=luong&req=copy_luong" method="post" enctype="multipart/form-data">
                <div class="form-group mt-1 d-flex">
                    <div class="form-group">
                        <input type="hidden" name="id_index" value=<?=$id_index?>>
            ...
            <table class="table" style="width:100%" id="table_quan_ly_kpi__luong">
                ...
                <tbody>
                    ...
                    <tr class="td_hover" onclick="update_obj(<?=$item->id_canbo?>)">
                        ...
                        <td class="t-right"
                            onclick="return confirm_sweet('./form/ViewUser/KpiAct.php?page=luong&req=delete_by_nv&id_canbo=<?=$item->id_canbo?>&id_index=<?=$item->id_index?>')">
